...
module('Integration | Component | guide-section/subsection', function (hooks) {
  ...
  test('should render (2)', async function (assert) {
    ...
    assert.dom('[data-test-field="Subsection Title"]').hasText('Data Down, Actions Up');
  ...
  test('should render (4)', async function (assert) {
    ...
    assert
      ...
      .hasAttribute(
        'href',
        'https://github.com/ember-learn/ember-cheat-sheet/edit/main/translations/generating-files/generating-component/en-us.yaml'
      );
  });
  ...
  test('should render (5)', async function (assert) {
    ...
    assert
      ...
      .hasAttribute(
        'href',
        'https://github.com/ember-learn/ember-cheat-sheet/edit/main/translations/generating-files/generating-component/pt-br.yaml'
      );
  });
});
